...
public class BackLogController  {
    ...
    public ResponseEntity<?> updateProjectTask(@Valid @RequestBody ProjectTask projectTask, BindingResult bindingResult,
                                               @PathVariable String backlogId, @PathVariable String pt_id, Principal principal)
    {
        ...
        ProjectTask updatedProjectTask = projectTaskService.updateByProjectSequence(projectTask,backlogId, pt_id, principal.getName());
    ...
    public ResponseEntity<?> getProjectTask(@PathVariable String backlogId, @PathVariable String pt_id, Principal principal)
    {
        ProjectTask projectTask = projectTaskService.findPTByProjectSequence(backlogId, pt_id, principal.getName());
        return new ResponseEntity<ProjectTask>(projectTask, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> deleteProjectTask(@PathVariable String backlogId, @PathVariable String pt_id, Principal principal)
    {
        projectTaskService.deletePTByProjectSequence(backlogId, pt_id,principal.getName());
